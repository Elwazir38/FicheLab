...
def _exo_comptable():
    ...
    txt.append(r"\begin{tikzpicture}")
    txt.append(r"\draw[Maroon, fill=Gray] (0,0) rectangle (2,1);")
    txt.append(r"\draw[Maroon, fill=Gray] (14,5) rectangle (16,6);")
    txt.append(r"\draw[Maroon] (14,2) rectangle (16,3);")
    txt.append(r"\draw[Maroon] (14,3) rectangle (16,4);")
    txt.append(r"\foreach \i in {4, 6,..., 10}{")
    txt.append(r"    \draw[Maroon] (\i,0) rectangle ++(2,1);")
    txt.append(r"    \draw[Maroon, ultra thick, latex-] ({\i + 1},1.2) -- ({\i + 1},1.8);")
    txt.append(r"    \draw[Maroon] (\i,2) rectangle ++(2,1);")
    txt.append(r"    \draw[Maroon] (\i,3) rectangle ++(2,1);")
    txt.append(r"}")
    txt.append(r"\draw[Maroon, ultra thick, latex-] (2.2,.5) -- (3.8,.5);")
    txt.append(r"\draw[Maroon, ultra thick, -latex] (12.2,2.5) -- (13.8,2.5);")
    txt.append(r"\draw[Maroon, ultra thick, -latex] (12.2,3.5) -- (13.8,3.5);")
    txt.append(r"\draw[Maroon, ultra thick, latex-] (15,4.8) -- (15,4.2);")
    txt.append(r"\draw (5,2.5) node{$%s$};" % texify([splitting(lexo[0])])[0])
    txt.append(r"\draw (7,2.5) node{$%s$};" % texify([splitting(lexo[1])])[0])
    txt.append(r"\draw (9,2.5) node{$%s$};" % texify([splitting(lexo[2])])[0])
    txt.append(r"\draw (11,2.5) node{$%s$};" % texify([splitting(lexo[3])])[0])
    txt.append(r"\draw (5,3.5) node{$%s$};" % texify([splitting(lexo[4])])[0])
    txt.append(r"\draw (7,3.5) node{$%s$};" % texify([splitting(lexo[5])])[0])
    txt.append(r"\draw (9,3.5) node{$%s$};" % texify([splitting(lexo[6])])[0])
    txt.append(r"\draw (11,3.5) node{$%s$};" % texify([splitting(lexo[7])])[0])
    exo.extend(txt)
    txt.append(r"\draw (5,.5) node{$%s$};" % expr[0][-1])
    txt.append(r"\draw (7,.5) node{$%s$};" % expr[1][-1])
    txt.append(r"\draw (9,.5) node{$%s$};" % expr[2][-1])
    txt.append(r"\draw (11,.5) node{$%s$};" % expr[3][-1])
    txt.append(r"\draw (15,2.5) node{$%s$};" % expr[4][-1])
    txt.append(r"\draw (15,3.5) node{$%s$};" % expr[5][-1])
    txt.append(r"\draw (1,.5) node{$%s$};" % expr[6][-1])
    txt.append(r"\draw (15,5.5) node{$%s$};" % expr[7][-1])
    cor.extend(txt)
