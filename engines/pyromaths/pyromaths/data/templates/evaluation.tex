...
\sisetup{locale=FR} % Use commas as decimal separator
...
\newcounter{tikzmark}
\tikzset{tikzmarksuffix=-\thetikzmark}%
\usepackage{pgfplots}
\usepackage{tkz-tab}
...
\newcommand*\exercice{%
  % TODO tikz \psset{unit=1cm, dash=4pt 4pt, PointName=default,linecolor=Maroon, dotstyle=x, linestyle=solid, hatchcolor=Peru, gridcolor=Olive, subgridcolor=Olive, fillcolor=Peru}
  \refstepcounter{exo}%
